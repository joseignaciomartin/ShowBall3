function preload() {
    ...
    game.load.image('auto',               '../assets/img/balls/auto.png');
    game.load.image('manual',             '../assets/img/balls/manual.png');
    ...
    game.load.spritesheet('ballGif',      '../assets/img/balls/ballGif.png',      99 + 10, 100 + 10);
